...
{
    ui->setupUi(this);
//    QFile file(":/styles/iosettingsform.qss");
...
//    }
    ...
    ui->comboBox_BaudRate->setItemDelegate(new QStyledItemDelegate(ui->comboBox_BaudRate));
    ui->comboBox_DataBits->setItemDelegate(new QStyledItemDelegate(ui->comboBox_DataBits));
    ui->comboBox_StopBits->setItemDelegate(new QStyledItemDelegate(ui->comboBox_StopBits));
    ui->comboBox_Parity->setItemDelegate(new QStyledItemDelegate(ui->comboBox_Parity));
    ui->cmb_tcpClientLocalAddr->setItemDelegate(new QStyledItemDelegate(ui->cmb_tcpClientLocalAddr));
    ui->cmb_tcpServerAimAddr->setItemDelegate(new QStyledItemDelegate(ui->cmb_tcpServerAimAddr));
    ui->cmb_tcpServerLocalAddr->setItemDelegate(new QStyledItemDelegate(ui->cmb_tcpServerLocalAddr));
    ...
    ui->pushButton_Setting->setVisible(true);
